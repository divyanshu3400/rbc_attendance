...
class ProfileFormState extends State<AddEmployee> {
  File? _selectedImage;
                    ...
                    items: workMode.map((String workMode) {
                      return DropdownMenuItem<String>(
                        ...
                        child: Text(
                          workMode,
                          style: TextStyle(
                            color: selectedWorkMode == workMode ? Colors.purpleAccent : Colors.black, // Set different colors based on selection
                          ),
                        ),
                      );
                    }).toList(),
  ...
  void uploadData(String name, String email, String designation, String phone,
      String selectedWorkMode) async {
